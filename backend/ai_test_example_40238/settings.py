"""
Django settings for ai_test_example_40238 project.
...
ROOT_URLCONF = 'ai_test_example_40238.urls'
...
WSGI_APPLICATION = 'ai_test_example_40238.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ai_test_example_40238 API",
    "DESCRIPTION": "API documentation for ai_test_example_40238 App",
    "VERSION": "v1",
}
